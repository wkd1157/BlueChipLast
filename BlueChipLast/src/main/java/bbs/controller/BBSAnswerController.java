...
public class BBSAnswerController {
	...
	@RequestMapping("/bbs/content.idol")
	public ModelAndView content(@RequestParam int num,@RequestParam int pageNum, HttpServletRequest request) //같아서 생략
	{
	...
	@RequestMapping("/bbs/answer.idol")
