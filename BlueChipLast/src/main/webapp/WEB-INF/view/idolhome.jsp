		...
		<div id="main">
			<div class="inner">
				...
				<header id="header">
					...
					<a href="main.idol" class = "logo"><strong>Idol-Group</strong> Ranking Site</a>
				...
				<div class="content">
					...
					<p>
					<c:if test="${IMDto.koreanname != null}"><b>KoreanName</b> : ${IMDto.koreanname}<br></c:if>
					<c:if test="${IMDto.debutalbum != null}"><b>DebutAlbum</b> : ${IMDto.debutalbum}<br></c:if>
					<c:if test="${IMDto.members != null}"><b>Member</b> : ${IMDto.members}<br></c:if>
					<c:if test="${IMDto.leader != null}"><b>Leader</b> : ${IMDto.leader}<br></c:if>
					<c:if test="${IMDto.entertainment != null}"><b>Entertainment</b> : ${IMDto.entertainment}<br></c:if>
					<c:if test="${IMDto.mainprize != null}"><b>MainPrize</b> : ${IMDto.mainprize}<br></c:if>
					<c:if test="${IMDto.breakyear != null}"><b>BreakYear</b> : ${IMDto.breakyear}<br></c:if>			
					</p>
					<ul class="actions">
						<li><a href="#" class="button big">Learn More</a></li>
					</ul>
				</div>
				<span class="image object"> <img src="${PPDto.ppurl}"
					alt="" />
				</span> </section>
